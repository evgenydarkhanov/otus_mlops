...
Задача определения мошеннических операций может быть сведена к задаче классификации с известными метриками: Accuracy, Precision, Recall, Fβ-Score. Стоит принять во внимание особенности конкретной решаемой задачи:
