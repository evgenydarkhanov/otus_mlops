...
| <!-- -->     | <!-- -->        |
| :---: | :--- |
| **S** | Получить доступ к историческим данным транзакций (CSV-файлы) за последние 12 месяцев, провести EDA |
| **M** | Подготовить отчёт по EDA, определить набор признаков для модели, подготовить датасеты |
...
| **M** | Достигнуть целевые показатели метрик на валидационном множестве, выбрать лучшую модель |
| **A** | При наличии обработанных данных и вычислительных ресурсов |
| **R** | baseline модель - основа антифрод системы |
| **T** | 3 недели |

**3. Спроектировать архитектуру системы и развернуть инфраструктуру**

| <!-- -->     | <!-- -->        |
| :---: | :--- |
| **S** | На основе декомпозиции системы и требований выбрать облачного провайдера и конкретные сервисы |
| **M** | Развернуть инфраструктуру. Подготовить документ с архитектурной схемой и обоснованием выбора |
| **A** | При наличии экспертизы в облачных технологиях, архитектуре, ML |
| **R** | Необходимо для разработки MVP и демонстрации работы |
| **T** | 4 недели |
...
| **R** | Демонстрация жизнеспособности |
| **T** | 4 недель |
