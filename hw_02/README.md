...
Разделил большой файл `main.tf` по ресурсам на несколько меньших.
...
`.env.example` - пример того, как должен выглядеть файл `.env`, в который записывается информация о бакете в течение выполнения команды `make apply`.
...
32580,65 ₽ (Spark, 4 ноды) против 1021,83 ₽ (Object Storage 464 GB).
